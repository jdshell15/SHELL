...
public class Dispatcher {
	...
	public static Object process(HttpServletRequest request, HttpServletResponse response) {
		final String uri = request.getRequestURI().replace("/p1-webapp", "");
		...
		case"/reimbursement":
			System.out.println("inside /reimbursement for managers in dispatcher process");
	...
	public static Object processPost(HttpServletRequest request, HttpServletResponse response) {
		final String uri = request.getRequestURI().replace("/p1-webapp/api", "");
